...
python train.py --wandb --count --ae_recon_loss --ae_er_train --log_pos --device "cuda" --log_freq 10000 --learning_rate 0.0003 --batch_size 256 \
                ...
                --ppo_iters 10 --ppo_clip 0.2 --rl_start_step 500000 --beta 0.1 --ae_model_type "vqvae" --filter_size 6 --codebook_size 256 \
                --beta 0.01 --env_name "minigrid-door-key-stochastic" --stochastic "categorical"
